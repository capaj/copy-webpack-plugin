...
| `cache` | N | false | Enable `transform` caching |
| `cacheKey` | N | `JSON.stringify({ 'copy-webpack-plugin': version, pattern: pattern, absoluteFrom: file.absoluteFrom, content: content })` | Allows you to override default cache key generator |
